...
happyReduction_20 (HappyTerminal (TIdent happy_var_1))
	 =  HappyAbsSyn12
...
happyNewToken action sts stk (tk:tks) =
	...
	TLength -> cont 34;
	TWhile -> cont 35;
	TIntLiteral happy_dollar_dollar -> cont 36;
	TIdent happy_dollar_dollar -> cont 37;
	TLeftBrace -> cont 38;
	TRightBrace -> cont 39;
	TComma -> cont 40;
	TLeftBrack -> cont 41;
	TRightBrack -> cont 42;
	TOp happy_dollar_dollar -> cont 43;
	TComOp happy_dollar_dollar -> cont 44;
	TLeftParen -> cont 45;
	TRightParen -> cont 46;
	TSemiColon -> cont 47;
	TPeriod -> cont 48;
...
newl tks = happySomeParser where
