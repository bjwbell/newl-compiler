...
codeGenMethodDecl (MethodDecl theType methodName formalList varDeclList statementList exp) m context = do
  ...
  codeGenMethodStatementList bld statementList context
...
codeGenMethodStatementList :: U.Builder -> StatementList -> [(String, String)] -> IO String
codeGenMethodStatementList _ Empty _ = "Ok"
codeGenMethodStatementList bld (StatementList rest stm) context =
    do
      codeGenMethodStatement bld stm context 
      codeGenMethodStatementList bld rest context
      return "Ok"
  
codeGenMethodStatement :: U.Builder -> Statement -> [(String, String)] -> IO String
codeGenMethodStatement bld (SPrint exp) context = 
    do
      return codeGenSPrint bld exp context

codeGenMethodsStatement _ _ _ = 
    do
      return "Not implemented" 

codeGenSPrint :: U.Builder -> Exp -> [(String, String)] -> IO String
codeGenSPrint bld (ExpString string) context = 
    do
      -- U.makeCall putsFunc bld string
...
codeGenExp (ExpString string) bld context =
    do 
